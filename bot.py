...
if __name__ == "__main__":
    ...
    if running_pid is not None:
        print(
            ...
            f"\n"
            f"\n     {Fore.WHITE}FunPay Universal из этой папки уже работает"
    ...
    try:
        ...
        set_title(f"FunPay Universal v{VERSION} by @friedfluoride")
        print(
            f"\n\n   {Fore.LIGHTYELLOW_EX}┌───────────────────────────────────────┐\n"
            ...
            f"\n     {Fore.WHITE}· Новости: {Fore.LIGHTWHITE_EX}t.me/friedfunpay"
