# FunPay Universal
[![telegram](https://img.shields.io/badge/telegram-%D0%BA%D0%B0%D0%BD%D0%B0%D0%BB-blue?style=for-the-badge&logo=telegram)](https://t.me/friedfunpay)
...
- **💬 Просмотр чатов** (отправка, чтение сообщений, изображения...)
- **📋 Просмотр заказов** (возвраты, открытие чата, ответ на отзыв...)
- **🛍️ Управление лотами** (удаление, вкл/выкл, редактирование цены и описания...)
- **🌟 Просмотр отзывов** (ответ, удаление ответа...)
...
- **🏷️ Заменители в сообщениях** (`{user.username}`, `{order.title}`, `{account.balance}`...)
- и многое другое...
...
- **💸 Авто-вывод средств** (на карту, USDT, ЮMoney и другие)
- **🌐 Подключение прокси**
- и многое другое...
...
Если бот уже настроен — URL можно задать или убрать прямо в Telegram боте: **/start** → **🛜 Соединение** → **🔗 Кастомный URL Telegram API**. После изменения перезагрузите бота, чтобы новый URL применился.
...
<details>
  ...
  **`meta.py`**:
  ...
  LINKS = "https://t.me/friedfluoride, https://t.me/friedfunpay"
  ```
...
- **Новости:** [@friedfunpay](https://t.me/friedfunpay)
