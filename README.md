...
2. Убедитесь, что у вас установлен **Python версии 3.11.x** (на других версиях работа бота не гарантируется). Если не установлен, сделайте это, перейдя по ссылке https://www.python.org/downloads/release/python-31210/ (при установке нажмите на пункт `Add to PATH`)
