...
## 🆕 Появится в версии 1.2.0:
- Вкладка активных заказов в Telegram боте
- Возможно подачи заказов в тех. поддержку для их закрытия. Вы сможете создать тикеты для всех ваших активных заказов с целью их подтверждения всего по нажатию одной кнопки. Также можно будет создать тикет и для одного заказа
