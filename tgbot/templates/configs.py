...
def configs_text():
    txt = textwrap.dedent(f"""
        ...
        <b>Все конфиги</b> — архив со всеми настройками из папки bot_settings (сообщения, команды, авто-выдачи, авто-ответы).
        <b>Конфиги + дата</b> — то же самое плюс данные бота из папки bot_data (кэш заказов, время поднятия категорий, список инициализированных пользователей).
        ...
        ❗ <b>Не передавайте конфиги третьим лицам</b> — в них лежат ваш Golden Key, токен Telegram бота и ключ-пароль
    """)
    return txt
